...
async function seedCanvas() {
  const canvas = {
    notes: [
      { id: 1, text: 'Hero: single promise + strong CTA', x: 80, y: 80, color: 'blue', size: 'large', created: '2026-06-07' },
      { id: 2, text: 'Proof: testimonial + launch metric', x: 370, y: 90, color: 'green', size: 'medium', created: '2026-06-07' },
      { id: 3, text: 'Pricing: 3 tiers, one highlighted', x: 650, y: 120, color: 'yellow', size: 'medium', created: '2026-06-07' },
      { id: 4, text: 'FAQ: reduce decision friction', x: 930, y: 110, color: 'purple', size: 'medium', created: '2026-06-07' },
      { id: 5, text: 'Content owners: design, copy, QA', x: 190, y: 330, color: 'pink', size: 'medium', created: '2026-06-07' },
      { id: 6, text: 'Analytics: CTA, scroll, pricing clicks', x: 520, y: 350, color: 'orange', size: 'medium', created: '2026-06-07' },
      { id: 7, text: 'Privacy copy and consent wording', x: 850, y: 370, color: 'red', size: 'medium', created: '2026-06-07' },
      { id: 8, text: 'Mobile smoke path', x: 330, y: 570, color: 'blue', size: 'small', created: '2026-06-07' },
      { id: 9, text: 'Launch decision gate', x: 650, y: 590, color: 'green', size: 'large', created: '2026-06-07' },
      { id: 10, text: 'Post-launch backlog', x: 960, y: 580, color: 'yellow', size: 'small', created: '2026-06-07' },
    ],
    connections: [
      { from: 1, to: 2, fromPort: 'right', toPort: 'left' },
      { from: 2, to: 3, fromPort: 'right', toPort: 'left' },
      { from: 3, to: 4, fromPort: 'right', toPort: 'left' },
      { from: 1, to: 5, fromPort: 'bottom', toPort: 'left' },
      { from: 5, to: 6, fromPort: 'right', toPort: 'left' },
      { from: 6, to: 7, fromPort: 'right', toPort: 'left' },
      { from: 5, to: 8, fromPort: 'bottom', toPort: 'left' },
      { from: 8, to: 9, fromPort: 'right', toPort: 'left' },
      { from: 7, to: 9, fromPort: 'bottom', toPort: 'right' },
