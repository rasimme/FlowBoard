...
| Native Control UI rail | Project switcher, "tasks needing me" (review + blocked/stuck) and status line inside the OpenClaw Control UI; host-theme integration | ✅ [openclaw-integration.md](openclaw-integration.md) + [user guide](../guide/openclaw-control-ui.md) | ✅ ADR-0037, ADR-0040 | T-487-8 |
| Native Control UI board | Kanban on the feature contract: moves, work state, approve gate, in-column reorder, archive/trash with undo, New task, panel edits and comments; `p.*` deep links incl. tab and file | ✅ [openclaw-integration.md](openclaw-integration.md) + [user guide](../guide/openclaw-control-ui.md) | ✅ ADR-0037, ADR-0040 | T-498, T-499 |
| Dashboard embed mode | Ideas/Files/Projects (and transient Specify) framed as single surfaces in the Control UI; embed protocol v1 with source/origin checks; framed-write attribution boundary | ✅ [openclaw-integration.md](openclaw-integration.md) + [user guide](../guide/openclaw-control-ui.md) | ✅ ADR-0037 | T-499 |
