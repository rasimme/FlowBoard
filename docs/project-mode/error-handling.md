...
- **Missing spec or capability doc** → report and continue. Use the rules manifest in the injected `FLOWBOARD.md` context (or `GET /api/projects/<name>/bootstrap`) as the coarse-grained fallback.
