...
import { ICONS } from '../utils.js?v=8';
...
import { renderPromoteButton, sendPromote, bindToolbarEvents, updateToolbar, applyFormattingToTextarea } from './toolbar.js?v=11';
import { bindCanvasEvents } from './events.js?v=1';
import { renderClusterFrames } from './clusters.js?v=1';

// canvas.css is imported via Vite in main.jsx — no runtime injection needed
